			...
			<div className='flex flex-col justify-end rounded-xl'>
				<div className='flex flex-col mb-1 drop-shadow-2xl'>
					<div className='flex flex-row justify-center items-center'>
						...
						<span className='text-yellow-500 text-center text-xl p-1 drop-shadow-custom'>
							{guardian.light}
						</span>
					</div>
					<div className='flex flex-row '>
						<svg
							...
							strokeWidth={1.5}
							stroke='white'
							className='w-3 h-3 m-auto drop-shadow-custom'>
							<path
								strokeLinecap='round'
						...
						<span className='text-gray-300 text-center text-lg p-1 drop-shadow-2xl text-bold drop-shadow-custom'>
							<ReactTimeAgo
