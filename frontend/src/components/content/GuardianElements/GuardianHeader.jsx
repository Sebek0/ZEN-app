			...
			<div className='flex flex-col justify-end rounded-xl'>
				<div className='flex flex-col mb-1 drop-shadow-2xl'>
					<div className='flex flex-row justify-center items-center'>
						...
						<span className='text-yellow-500 text-center text-xl p-1 font-shadow'>
							{guardian.light}
						</span>
					</div>
					<div className='flex flex-row bg-secondary rounded-xl'>
						...
						<span className='text-gray-300 text-center text-lg p-1 drop-shadow-2xl text-bold font-shadow'>
							<ReactTimeAgo
